...
window.svg=function(m){
  try{
    ...
    return '<div style="width:32px;height:75px;position:relative;display:inline-block;margin:2px;">' +
      '<img src="' + file + '" style="width:100%;height:100%;border-radius:6px;" onerror="this.style.display=\'none\'">' +
      '<span style="position:absolute;bottom:1px;left:0;right:0;text-align:center;font-size:6px;color:#151515;font-family:monospace;">' + num + '</span>' +
      '</div>';
  }catch(e){
    return '<div style="width:32px;height:75px;background:#f5f0e6;border-radius:6px;"></div>';
  }
};
